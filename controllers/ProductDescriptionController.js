...
exports.findAll = (req, res) =>{
    ProductDescriptionModel.find().then(
...
exports.update=(req, res) =>{
     ...
     */
    ProductDescriptionModel.findByIdAndUpdate(req.params.id, productDescription,{new: true}/*{new: true} es opcional y sirve para poder ver los datos actualizados en postman cuando se envien (punto 3) */).then( //Esta diciendo que busque por el id y que lo actualice
    data=>{
        res.send(data)
    }
    ).catch(
...
exports.deleteOne = (req, res)=>{
     ...
     */
    ProductDescriptionModel.findByIdAndRemove(req.params.id).then(
